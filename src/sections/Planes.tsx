  ...
  airsoft: [
    {
      ...
      duration: "1 hora",
      featured: false,
      perks: [ "CQB + La Fortaleza", "Réplica M4", "Máscara, chaleco y 450 balines"],
    },
    {
      ...
      duration: "2 horas",
      featured: true,
      perks: ["CQB + La Fortaleza + Élite Town", "Réplica M4", "Máscara, chaleco y 450 balines"],
    },
    {
      name: "Adicionales",
      price: "Desde $6.000",
      duration: "Opcionales",
      featured: false,
      perks: ["Recarga 450 balines: $15.000", "Guantes: $6.000 por hora", "Grupo mínimo: 4 personas"],
    },
  ],
  gelsoft: [
    {
    ...
    },
    {
      ...
      duration: "2 horas",
      featured: true,
      perks: ["3 campos: Kill House + El Bunker + Élite Town", "Más de 5 modos de juego", "El precio varía según la réplica elegida", "Edad mínima: 6 años"],
    },
    {
      name: "Recargas",
      price: "$10.000 – $15.000",
      duration: "Adicional",
      featured: false,
      perks: ["Normal 400 balas: $10.000", "Escopeta 800 balas: $12.000", "Metralleta 2.000 balas: $15.000"],
    },
  ],
};
